...
<div class="tocify-wrapper">
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-v1-regions">Retrieve all regions</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-regions--id-">
                                <a href="#endpoints-GETapi-v1-regions--id-">Retrieve a single region</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-companies-trash--id-">
                                <a href="#endpoints-GETapi-v1-companies-trash--id-">Restore the specified soft deleted company from trash.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-companies">
                                <a href="#endpoints-GETapi-v1-companies">List all companies.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-companies">
                                <a href="#endpoints-POSTapi-v1-companies">Add a company to the database.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-companies--id-">
                                <a href="#endpoints-GETapi-v1-companies--id-">Display a single company.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-v1-companies--id-">
                                <a href="#endpoints-PUTapi-v1-companies--id-">Update the specified company in the database.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-v1-companies--id-">
                                <a href="#endpoints-DELETEapi-v1-companies--id-">Soft delete the specified company from the database</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
    ...
    <ul class="toc-footer" id="last-updated">
        <li>Last updated: September 19, 2024</li>
    </ul>
</div>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="endpoints">Endpoints</h1>
                                ...
                                <h2 id="endpoints-GETapi-v1-regions">Retrieve all regions</h2>
...
<div class="bash-example">
    ...
    --get "http://localhost/api/v1/regions" \
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-regions--id-">Retrieve a single region</h2>
...
<span id="example-requests-GETapi-v1-regions--id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-GETapi-v1-regions--id-">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-v1-regions--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-regions--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-regions--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-regions--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-regions--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-regions--id-" data-method="GET"
      data-path="api/v1/regions/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-regions--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-regions--id-"
                    onclick="tryItOut('GETapi-v1-regions--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-regions--id-"
                    onclick="cancelTryOut('GETapi-v1-regions--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-regions--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/regions/{id}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-regions--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-regions--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               step="any"               name="id"                data-endpoint="GETapi-v1-regions--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the region. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-companies-trash--id-">Restore the specified soft deleted company from trash.</h2>
...
<span id="example-requests-GETapi-v1-companies-trash--id-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/v1/companies/trash/distinctio" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/v1/companies/trash/distinctio"
);
...
<span id="example-responses-GETapi-v1-companies-trash--id-">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <details class="annotation">
...
<code class="language-json" style="max-height: 300px;">{
    &quot;success&quot;: true,
    &quot;message&quot;: &quot;Company with id: distinctio restored&quot;,
    &quot;data&quot;: &quot;distinctio&quot;
}</code>
 </pre>
    </span>
<span id="execution-results-GETapi-v1-companies-trash--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-companies-trash--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-companies-trash--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-companies-trash--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-companies-trash--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-companies-trash--id-" data-method="GET"
      data-path="api/v1/companies/trash/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-companies-trash--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-companies-trash--id-"
                    onclick="tryItOut('GETapi-v1-companies-trash--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-companies-trash--id-"
                    onclick="cancelTryOut('GETapi-v1-companies-trash--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-companies-trash--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/companies/trash/{id}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-companies-trash--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-companies-trash--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="GETapi-v1-companies-trash--id-"
               value="distinctio"
               data-component="url">
    <br>
<p>The ID of the trash. Example: <code>distinctio</code></p>
            </div>
                    </form>

                    <h2 id="endpoints-GETapi-v1-companies">List all companies.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-companies">Add a company to the database.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-companies--id-">Display a single company.</h2>
...
<p>The ID of the company. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-v1-companies--id-">Update the specified company in the database.</h2>
...
<p>The ID of the company. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-v1-companies--id-">Soft delete the specified company from the database</h2>
